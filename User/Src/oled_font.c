...
const uint8_t OLED_F8x16_Hope[][16] =
{
...
const uint8_t OLED_F6x8_Hope[][6] = 
{
...
const uint8_t OLED_F8x16_Regret[][16] =
{
...
const uint8_t OLED_F6x8_Regret[][6] =
{
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,/*" ",0*/

	0xFF,0xFF,0xB3,0xBF,0xFF,0xFF,/*"!",1*/

	0xFF,0xFD,0xFD,0xFD,0xFF,0xFF,/*""",2*/

	0xDF,0x83,0xD7,0xD7,0xC1,0xDF,/*"#",3*/

	0xFF,0x93,0xB5,0x8B,0xDB,0xFF,/*"$",4*/

	0xF3,0xAD,0xC3,0x83,0xAD,0x8F,/*"%",5*/

	0xCF,0xB3,0x85,0x93,0xAF,0xBF,/*"&",6*/

	0xFF,0xFD,0xFF,0xFF,0xFF,0xFF,/*"'",7*/

	0xFF,0xFF,0xFF,0x83,0x7D,0xFF,/*"(",8*/

	0xFF,0xBD,0xC3,0xFF,0xFF,0xFF,/*")",9*/

	0xFF,0xE7,0xC7,0xEF,0xE7,0xFF,/*"*",10*/

	0xFF,0xFF,0xEF,0xE7,0xEF,0xFF,/*"+",11*/

	0xFF,0x3F,0xFF,0xFF,0xFF,0xFF,/*",",12*/

	0xF7,0xF7,0xF7,0xF7,0xF7,0xF7,/*"-",13*/

	0xFF,0xBF,0xFF,0xFF,0xFF,0xFF,/*".",14*/

	0xFF,0xBF,0xCF,0xF7,0xF9,0xFF,/*"/",15*/

	0xFF,0x83,0xBD,0xBD,0x83,0xFF,/*"0",16*/

	0xFF,0xFF,0xBB,0x83,0xFF,0xFF,/*"1",17*/

	0xFF,0x9B,0x9D,0xAD,0xB3,0xFF,/*"2",18*/

	0xFF,0x9B,0xBD,0xB5,0x83,0xFF,/*"3",19*/

	0xFF,0xEF,0xD7,0x83,0xDF,0xFF,/*"4",20*/

	0xFF,0x93,0xB3,0xB3,0x8F,0xFF,/*"5",21*/

	0xFF,0x83,0xB5,0xB5,0x8B,0xFF,/*"6",22*/

	0xFF,0xFB,0x9B,0xE3,0xFB,0xFF,/*"7",23*/

	0xFF,0x83,0xB5,0xAD,0x83,0xFF,/*"8",24*/

	0xFF,0xA3,0xAD,0xAD,0xC3,0xFF,/*"9",25*/

	0xFF,0xFF,0xB7,0xB7,0xFF,0xFF,/*":",26*/

	0xFF,0xFF,0x37,0xFF,0xFF,0xFF,/*";",27*/

	0xFF,0xE7,0xD7,0xDB,0xBD,0xFF,/*"<",28*/

	0xFF,0xE7,0xE7,0xE7,0xE7,0xFF,/*"=",29*/

	0xFF,0xBD,0xDB,0xD7,0xE7,0xFF,/*">",30*/

	0xFF,0xFB,0x9D,0xAD,0xF3,0xFF,/*"?",31*/

	0xE7,0x9B,0x85,0xA9,0x93,0xE7,/*"@",32*/

	0xBF,0xCF,0xE3,0xE3,0x8F,0xFF,/*"A",33*/

	0xFF,0x83,0xAB,0xAB,0xA3,0xDF,/*"B",34*/

	0xE7,0x9B,0xBD,0xBD,0xBD,0xDB,/*"C",35*/

	0xFF,0x83,0xBB,0xBB,0xDB,0xE7,/*"D",36*/

	0xFF,0x83,0xAB,0xAB,0xBB,0xFF,/*"E",37*/

	0xFF,0x83,0xEB,0xEB,0xE3,0xFB,/*"F",38*/

	0xC7,0xBB,0xBD,0xBD,0x9B,0xFF,/*"G",39*/

	0xFF,0x83,0xEF,0xEF,0x83,0xFF,/*"H",40*/

	0xFF,0xFF,0x83,0xBB,0xFF,0xFF,/*"I",41*/

	0x7F,0x7F,0x7F,0x03,0xFB,0xFF,/*"J",42*/

	0xFF,0x83,0xF7,0xCB,0xBF,0xFF,/*"K",43*/

	0xFF,0x83,0xBF,0xBF,0xBF,0xFF,/*"L",44*/

	0x8F,0xB3,0x8F,0xEF,0x83,0xFF,/*"M",45*/

	0xFF,0x83,0xF7,0xEF,0xC3,0xFF,/*"N",46*/

	0xE7,0x9B,0xBD,0xBD,0xBB,0xC7,/*"O",47*/

	0xFF,0x83,0xEB,0xEB,0xF3,0xFB,/*"P",48*/

	0xC7,0xBB,0x9D,0xBD,0x3B,0xC7,/*"Q",49*/

	0xFF,0x83,0xEB,0xEB,0x93,0xFF,/*"R",50*/

	0xFF,0xB3,0xB5,0xAD,0x8B,0xFF,/*"S",51*/

	0xFB,0xFB,0x83,0xFB,0xFB,0xFB,/*"T",52*/

	0xFF,0x83,0xBF,0xBF,0x83,0xFF,/*"U",53*/

	0xFF,0xF3,0xCF,0xCF,0xF3,0xFF,/*"V",54*/

	0xFF,0xC3,0xEB,0xC3,0xE3,0xFB,/*"W",55*/

	0xFF,0xBB,0xD7,0xC7,0xBB,0xFF,/*"X",56*/

	0xFF,0xFB,0x87,0xF7,0xFB,0xFF,/*"Y",57*/

	0xFF,0x9B,0xAB,0xB3,0xBB,0xFF,/*"Z",58*/

	0xFF,0xFF,0x01,0x7D,0x7F,0xFF,/*"[",59*/

	0xFF,0xF9,0xF7,0xCF,0xBF,0xFF,/*"\",60*/

	0xFF,0x7F,0x7D,0x01,0xFF,0xFF,/*"]",61*/

	0xFF,0xFE,0xFE,0xFE,0xFE,0xFF,/*"^",62*/

	0x7F,0x7F,0x7F,0x7F,0x7F,0x7F,/*"_",63*/

	0xFF,0xFE,0xFE,0xFF,0xFF,0xFF,/*"`",64*/

	0xFF,0x9F,0xA7,0xA7,0x8F,0xBF,/*"a",65*/

	0xFF,0x81,0xB7,0xB7,0x8F,0xFF,/*"b",66*/

	0xFF,0x8F,0xB7,0xB7,0xBF,0xFF,/*"c",67*/

	0xFF,0x8F,0xB7,0xB7,0x81,0xBF,/*"d",68*/

	0xFF,0x8F,0x97,0x97,0xAF,0xFF,/*"e",69*/

	0xFF,0xF7,0x83,0xF3,0xF3,0xFF,/*"f",70*/

	0xFF,0x0F,0x17,0x17,0x27,0xF7,/*"g",71*/

	0xFF,0x81,0xF7,0xF7,0x8F,0xFF,/*"h",72*/

	0xFF,0xF7,0x87,0xBF,0xFF,0xFF,/*"i",73*/

	0xFF,0x7F,0x7F,0x77,0x85,0xFF,/*"j",74*/

	0xFF,0x81,0xEF,0xC7,0xB7,0xFF,/*"k",75*/

	0xFF,0xFF,0x81,0xBF,0xFF,0xFF,/*"l",76*/

	0x87,0xB7,0xB7,0x8F,0xB7,0x8F,/*"m",77*/

	0xF7,0x87,0xF7,0xF7,0x8F,0xFF,/*"n",78*/

	0xFF,0x8F,0xB7,0xB7,0x8F,0xFF,/*"o",79*/

	0xF7,0x07,0xB7,0xB7,0x8F,0xFF,/*"p",80*/

	0xFF,0x8F,0xB7,0xB7,0x0F,0xFF,/*"q",81*/

	0xF7,0xB7,0x8F,0xF7,0xF7,0xFF,/*"r",82*/

	0xFF,0xAF,0xA7,0x97,0x97,0xFF,/*"s",83*/

	0xFF,0xF7,0x83,0xB7,0xB7,0xFF,/*"t",84*/

	0xF7,0x87,0xBF,0xBF,0x87,0xBF,/*"u",85*/

	0xF7,0xE7,0xDF,0xDF,0xE7,0xFF,/*"v",86*/

	0xF7,0xC7,0xD7,0xC7,0xC7,0xF7,/*"w",87*/

	0xFF,0xB7,0xC7,0xC7,0xB7,0xFF,/*"x",88*/

	0xFF,0x67,0x5F,0x9F,0xE7,0xF7,/*"y",89*/

	0xFF,0xB7,0x97,0xA7,0xB7,0xFF,/*"z",90*/

	0xFF,0xFF,0xFF,0x81,0x7F,0xFF,/*"{",91*/

	0xFF,0xFF,0xFF,0x00,0xFF,0xFF,/*"|",92*/

	0xFF,0x7F,0x81,0xFF,0xFF,0xFF,/*"}",93*/

	0xFF,0xFE,0xFE,0xFD,0xFD,0xFF,/*"~",94*/
